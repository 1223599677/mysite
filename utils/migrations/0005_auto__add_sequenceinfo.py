...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SequenceInfo'
        db.create_table(u'utils_sequenceinfo', (
            ...
            ('strain', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('sequence_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('public_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('strain_owner', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('industrial_application', self.gf('django.db.models.fields.TextField')()),
            ('document_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'utils', ['SequenceInfo'])


    def backwards(self, orm):
        # Deleting model 'SequenceInfo'
        db.delete_table(u'utils_sequenceinfo')
