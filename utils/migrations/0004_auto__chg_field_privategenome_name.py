...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrivateGenome.name'
        db.alter_column(u'utils_privategenome', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'PrivateGenome.name'
        db.alter_column(u'utils_privategenome', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
