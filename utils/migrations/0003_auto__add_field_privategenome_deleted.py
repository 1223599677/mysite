...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrivateGenome.deleted'
        db.add_column(u'utils_privategenome', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrivateGenome.deleted'
        db.delete_column(u'utils_privategenome', 'deleted')
