...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PrivateGenome.annotation_file'
        db.alter_column(u'utils_privategenome', 'annotation_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Changing field 'PrivateGenome.sequence_file'
        db.alter_column(u'utils_privategenome', 'sequence_file', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PrivateGenome.annotation_file'
        db.alter_column(u'utils_privategenome', 'annotation_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'PrivateGenome.sequence_file'
        db.alter_column(u'utils_privategenome', 'sequence_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'utils.privategenome': {
            ...
            'documents': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
